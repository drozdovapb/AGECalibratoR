...
\begin{minipage}{0.4\linewidth}
	\hskip 10mm
	\includegraphics[width=5.5cm]{images/1_2.pdf}
...
\hskip 10mm
\includegraphics[width=15cm]{images/3_7.pdf}
...
\item Open RStudio, load \texttt{main.R} (the source code can be downloaded from \href{https://github.com/drozdovapb/AGECalibratoR}{the git.hub repository}) and press the \texttt{Run App} button (it might be more convenient to open the app in browser). Alternativerly, navigate to \href{https://bioinfo.crbm.cnrs.fr/index.php?route=tools&tool=26}{the site}.

The window should look similar to the image below. 

\includegraphics[width=17.5cm]{images/shiny_app}

\item Select your table with the \texttt{Browse} button, choose the appropriate field separator if necessary and make sure everything worked well. The table with test data can be found in \href{https://github.com/drozdovapb/AGECalibratoR}{the git.hub repository} in the "test\_data" folder.
...
\includegraphics[width=15cm]{images/medians}
